...
object FacebookShowOps {
  implicit val showFacebookVersion =
    Show.show[FacebookVersion](fbVersion => "v" + fbVersion.value)
  ...
  implicit val showFacebookAccessToken =
    Show.show[FacebookAccessToken](_.tokenValue.value)
  ...
  implicit val showFacebookApplicationId =
    Show.show[FacebookApplicationId](_.value)
