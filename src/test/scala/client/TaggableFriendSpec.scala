...
import domain.friends.{TaggableFriend, TaggableFriendId, TaggableFriends}
...
class TaggableFriendSpec extends FacebookClientSupport {
  ...
  val taggableFriend = TaggableFriend(TaggableFriendId("AaIjDECkFPXyF7R9N-t9ww7UnMauWLygCDRSsffGTDfC00Htau5Ci" +
  ...
  val taggableFriends = TaggableFriends(List(taggableFriend), Some(paging))
